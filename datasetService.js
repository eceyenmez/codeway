...
async function queryTotalUserNumber() {
  ...
  const sqlQuery = "SELECT * FROM `test-305121.test.total_user_number` order by date desc LIMIT 1";
...
async function queryDailyAverageDurations() {
  ...
  // The SQL query to run
  const sqlQuery = "SELECT * FROM `test-305121.test.daily_avg_session_time`";
